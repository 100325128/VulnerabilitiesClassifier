...
class FileManager() :
    ...
    def createOutputFiles(self) :
        ...
        if (messageError == "") :
           try:
              ...
              messageError = "Error while creating file " + CONST_PATH_OS_DESKTOP
        if (messageError == "") :
           try:
               ...
               messageError = "Error while creating file " + CONST_PATH_OS_MOBILE
        if (messageError == "") :
           try:
               ...
               messageError = "Error while creating file " + CONST_PATH_APPLICATION
        if (messageError == "") :
           try:
    ...
    def writeDesktopDefault(self, cve_id, cve_vulnerability, cvss) :
        maxColumns = 42
        auxList = [""] * maxColumns
    ...
    def writeMobile(self, cve_id, cve_vulnerability, vulnerable_mobile_list, cvss) :
    ...
    def writeApplication(self, cve_id, cve_vulnerability, vulnerable_ap_list, cvss) :
    ...
    def writeNoClassify(self, cve_id, cve_vulnerability, vulnerable_nc_list, cvss) :
        if (len(vulnerable_nc_list) != 0) :
           for vuln in vulnerable_nc_list :
               line = cve_id + ";" + cve_vulnerability + ";" + vuln + ";" + cvss + "\n"
    ...
    def setCandidateVulnerabilities(self) :
        ...
        try:
           ...
           messageError = "Error while reading file " + CONST_PATH_VULN_STATUS
        return messageError
